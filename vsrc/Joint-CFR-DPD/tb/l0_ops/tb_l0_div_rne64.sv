  ...
  initial begin
    ...
    begin : read_loop
      forever begin
        ...
        if (scan_rc != 3) begin
          $display("[L0][FAIL] op=div_rne64 malformed vector row, scan_rc=%0d", scan_rc);
          $finish;
        end

        got = div_rne64($signed(x_u), $signed(d_u));
    ...
    l0_report("div_rne64", case_cnt, mismatches);
    $finish;
  end
